...
#define __PYX_HAVE__softdtwc
#define __PYX_HAVE_API__softdtwc
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'softdtwc' */
static CYTHON_INLINE float __pyx_f_8softdtwc_softmin3(float, float, float, float); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_float = { "float", NULL, sizeof(float), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "softdtwc"
extern int __pyx_module_is_main_softdtwc;
int __pyx_module_is_main_softdtwc = 0;

/* Implementation of 'softdtwc' */
...
static const char __pyx_k_softdtwc[] = "softdtwc";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_softdtwc_pyx[] = "softdtwc.pyx";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Created_on_Mon_Sep_10_21_20_04[] = "\nCreated on Mon Sep 10 21:20:04 2018\n\n@author: chenhx1992\n";
...
static PyObject *__pyx_kp_s_dtw;
...
static PyObject *__pyx_n_s_softdtwc;
static PyObject *__pyx_kp_s_softdtwc_pyx;
...
static PyObject *__pyx_pf_8softdtwc_softdtwc(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_delta, PyArrayObject *__pyx_v_D, PyArrayObject *__pyx_v_R, PyArrayObject *__pyx_v_E, PyArrayObject *__pyx_v_G, float __pyx_v_gamma); /* proto */
...
static CYTHON_INLINE float __pyx_f_8softdtwc_softmin3(float __pyx_v_a, float __pyx_v_b, float __pyx_v_c, float __pyx_v_gamma) {
  ...
  float __pyx_t_3;
  float __pyx_t_4;
  __Pyx_RefNannySetupContext("softmin3", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_8softdtwc_1softdtwc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8softdtwc_1softdtwc = {"softdtwc", (PyCFunction)__pyx_pw_8softdtwc_1softdtwc, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8softdtwc_1softdtwc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("softdtwc (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_X,&__pyx_n_s_delta,&__pyx_n_s_D,&__pyx_n_s_R,&__pyx_n_s_E,&__pyx_n_s_G,&__pyx_n_s_gamma,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_delta)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, 1); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_D)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, 2); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_R)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, 3); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_E)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, 4); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_G)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, 5); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, 6); __PYX_ERR(0, 45, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "softdtwc") < 0)) __PYX_ERR(0, 45, __pyx_L3_error)
      }
    ...
    __pyx_v_gamma = __pyx_PyFloat_AsFloat(values[6]); if (unlikely((__pyx_v_gamma == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("softdtwc", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 45, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("softdtwc.softdtwc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_5numpy_ndarray, 1, "X", 0))) __PYX_ERR(0, 45, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_delta), __pyx_ptype_5numpy_ndarray, 1, "delta", 0))) __PYX_ERR(0, 46, __pyx_L1_error)
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_E), __pyx_ptype_5numpy_ndarray, 1, "E", 0))) __PYX_ERR(0, 49, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_G), __pyx_ptype_5numpy_ndarray, 1, "G", 0))) __PYX_ERR(0, 50, __pyx_L1_error)
  __pyx_r = __pyx_pf_8softdtwc_softdtwc(__pyx_self, __pyx_v_X, __pyx_v_delta, __pyx_v_D, __pyx_v_R, __pyx_v_E, __pyx_v_G, __pyx_v_gamma);
...
static PyObject *__pyx_pf_8softdtwc_softdtwc(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_delta, PyArrayObject *__pyx_v_D, PyArrayObject *__pyx_v_R, PyArrayObject *__pyx_v_E, PyArrayObject *__pyx_v_G, float __pyx_v_gamma) {
  int __pyx_v_m;
  int __pyx_v_n;
  int __pyx_v_d;
  int __pyx_v_i;
  ...
  __Pyx_RefNannySetupContext("softdtwc", 0);
  ...
  __pyx_pybuffernd_G.rcbuffer = &__pyx_pybuffer_G;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_delta.rcbuffer->pybuffer, (PyObject*)__pyx_v_delta, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_D.rcbuffer->pybuffer, (PyObject*)__pyx_v_D, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_R.rcbuffer->pybuffer, (PyObject*)__pyx_v_R, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_E.rcbuffer->pybuffer, (PyObject*)__pyx_v_E, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_G.rcbuffer->pybuffer, (PyObject*)__pyx_v_G, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
 ...
 *     for i in range(m+1):
 */
  (void)(memset(((void *)__pyx_v_R->data), 0, (((__pyx_v_m + 2) * (__pyx_v_n + 2)) * (sizeof(float)))));
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = 0;
    *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_5, __pyx_pybuffernd_R.diminfo[1].strides) = FLT_MAX;
  }
 ...
 */
    __pyx_t_6 = 0;
    __pyx_t_7 = __pyx_v_j;
    *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_7, __pyx_pybuffernd_R.diminfo[1].strides) = FLT_MAX;
  }
 ...
 */
  __pyx_t_8 = 0;
  __pyx_t_9 = 0;
  *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_R.diminfo[1].strides) = 0.0;
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_R.diminfo[1].strides) = ((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_D.diminfo[1].strides)) + __pyx_f_8softdtwc_softmin3((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_R.diminfo[1].strides)), (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_R.diminfo[1].strides)), (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_R.diminfo[1].strides)), __pyx_v_gamma));
    }
  }
 ...
 * 
 */
  __pyx_t_24 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_dtw, __pyx_n_s_format); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_24);
  __pyx_t_25 = __pyx_v_m;
  __pyx_t_26 = __pyx_v_n;
  __pyx_t_27 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_R.diminfo[1].strides))); if (unlikely(!__pyx_t_27)) __PYX_ERR(0, 82, __pyx_L1_error)
  ...
  if (!__pyx_t_28) {
    __pyx_t_23 = __Pyx_PyObject_CallOneArg(__pyx_t_24, __pyx_t_27); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 82, __pyx_L1_error)
    ...
    if (PyFunction_Check(__pyx_t_24)) {
      ...
      __pyx_t_23 = __Pyx_PyFunction_FastCall(__pyx_t_24, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 82, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_24)) {
      PyObject *__pyx_temp[2] = {__pyx_t_28, __pyx_t_27};
      __pyx_t_23 = __Pyx_PyCFunction_FastCall(__pyx_t_24, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 82, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_28); __pyx_t_28 = 0;
      __Pyx_GOTREF(__pyx_t_23);
      __Pyx_DECREF(__pyx_t_27); __pyx_t_27 = 0;
    } else
    #endif
    {
      __pyx_t_29 = PyTuple_New(1+1); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 82, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_29);
      __Pyx_GIVEREF(__pyx_t_28); PyTuple_SET_ITEM(__pyx_t_29, 0, __pyx_t_28); __pyx_t_28 = NULL;
      __Pyx_GIVEREF(__pyx_t_27);
      PyTuple_SET_ITEM(__pyx_t_29, 0+1, __pyx_t_27);
      __pyx_t_27 = 0;
      __pyx_t_23 = __Pyx_PyObject_Call(__pyx_t_24, __pyx_t_29, NULL); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 82, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_23);
      __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
  if (__Pyx_PrintOne(0, __pyx_t_23) < 0) __PYX_ERR(0, 82, __pyx_L1_error)
 ...
 *     for i in range(1, m+1):
 */
  (void)(memset(((void *)__pyx_v_E->data), 0, (((__pyx_v_m + 2) * (__pyx_v_n + 2)) * (sizeof(float)))));
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_31, __pyx_pybuffernd_D.diminfo[1].strides) = 0.0;
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_33, __pyx_pybuffernd_R.diminfo[1].strides) = (-FLT_MAX);
  }
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_35, __pyx_pybuffernd_D.diminfo[1].strides) = 0.0;
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_37, __pyx_pybuffernd_R.diminfo[1].strides) = (-FLT_MAX);
  }
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_E.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_E.diminfo[0].strides, __pyx_t_39, __pyx_pybuffernd_E.diminfo[1].strides) = 1.0;
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_43, __pyx_pybuffernd_R.diminfo[1].strides) = (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_41, __pyx_pybuffernd_R.diminfo[1].strides));
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_45, __pyx_pybuffernd_D.diminfo[1].strides) = 0.0;
 ...
 */
    for (__pyx_t_12 = (__pyx_v_m + 1)-1; __pyx_t_12 >= 1; __pyx_t_12-=1) {
 ...
 */
      ...
      __pyx_v_a = exp(((((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_47, __pyx_pybuffernd_R.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_48, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_49, __pyx_pybuffernd_R.diminfo[1].strides))) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_50, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_51, __pyx_pybuffernd_D.diminfo[1].strides))) / __pyx_v_gamma));
 ...
 */
      ...
      __pyx_v_b = exp(((((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_52, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_53, __pyx_pybuffernd_R.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_54, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_55, __pyx_pybuffernd_R.diminfo[1].strides))) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_56, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_57, __pyx_pybuffernd_D.diminfo[1].strides))) / __pyx_v_gamma));
 ...
 */
      ...
      __pyx_v_c = exp(((((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_58, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_59, __pyx_pybuffernd_R.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_R.rcbuffer->pybuffer.buf, __pyx_t_60, __pyx_pybuffernd_R.diminfo[0].strides, __pyx_t_61, __pyx_pybuffernd_R.diminfo[1].strides))) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_62, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_63, __pyx_pybuffernd_D.diminfo[1].strides))) / __pyx_v_gamma));
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_E.rcbuffer->pybuffer.buf, __pyx_t_70, __pyx_pybuffernd_E.diminfo[0].strides, __pyx_t_71, __pyx_pybuffernd_E.diminfo[1].strides) = ((((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_E.rcbuffer->pybuffer.buf, __pyx_t_64, __pyx_pybuffernd_E.diminfo[0].strides, __pyx_t_65, __pyx_pybuffernd_E.diminfo[1].strides)) * __pyx_v_a) + ((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_E.rcbuffer->pybuffer.buf, __pyx_t_66, __pyx_pybuffernd_E.diminfo[0].strides, __pyx_t_67, __pyx_pybuffernd_E.diminfo[1].strides)) * __pyx_v_b)) + ((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_E.rcbuffer->pybuffer.buf, __pyx_t_68, __pyx_pybuffernd_E.diminfo[0].strides, __pyx_t_69, __pyx_pybuffernd_E.diminfo[1].strides)) * __pyx_v_c));
    }
  }
 ...
 *     for i in range(m+1):
 */
  __pyx_t_23 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_24 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_zeros); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_24);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  __pyx_t_23 = __Pyx_PyInt_From_long((__pyx_v_m + 1)); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_29 = __Pyx_PyInt_From_long((__pyx_v_n + 1)); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_29);
  __pyx_t_27 = PyList_New(2); if (unlikely(!__pyx_t_27)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_27);
  ...
  __pyx_t_27 = 0;
  __pyx_t_27 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_27)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_27);
  __pyx_t_23 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_23);
  __pyx_t_28 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_float32); if (unlikely(!__pyx_t_28)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_28);
  __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
  if (PyDict_SetItem(__pyx_t_27, __pyx_n_s_dtype, __pyx_t_28) < 0) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_28); __pyx_t_28 = 0;
  __pyx_t_28 = __Pyx_PyObject_Call(__pyx_t_24, __pyx_t_29, __pyx_t_27); if (unlikely(!__pyx_t_28)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_28);
  __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
  __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
  __Pyx_DECREF(__pyx_t_27); __pyx_t_27 = 0;
  if (!(likely(((__pyx_t_28) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_28, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 109, __pyx_L1_error)
  __pyx_t_72 = ((PyArrayObject *)__pyx_t_28);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_tE.rcbuffer->pybuffer, (PyObject*)__pyx_t_72, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_tE = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_tE.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 109, __pyx_L1_error)
    } else {__pyx_pybuffernd_tE.diminfo[0].strides = __pyx_pybuffernd_tE.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_tE.diminfo[0].shape = __pyx_pybuffernd_tE.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_tE.diminfo[1].strides = __pyx_pybuffernd_tE.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_tE.diminfo[1].shape = __pyx_pybuffernd_tE.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_72 = 0;
  __pyx_v_tE = ((PyArrayObject *)__pyx_t_28);
  __pyx_t_28 = 0;
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_tE.rcbuffer->pybuffer.buf, __pyx_t_75, __pyx_pybuffernd_tE.diminfo[0].strides, __pyx_t_76, __pyx_pybuffernd_tE.diminfo[1].strides) = (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_E.rcbuffer->pybuffer.buf, __pyx_t_73, __pyx_pybuffernd_E.diminfo[0].strides, __pyx_t_74, __pyx_pybuffernd_E.diminfo[1].strides));
    }
  }
 ...
 */
  ...
  for (__pyx_t_77 = 0; __pyx_t_77 < __pyx_t_12; __pyx_t_77+=1) {
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_G.rcbuffer->pybuffer.buf, __pyx_t_92, __pyx_pybuffernd_G.diminfo[0].strides, __pyx_t_93, __pyx_pybuffernd_G.diminfo[1].strides) += (((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_tE.rcbuffer->pybuffer.buf, __pyx_t_84, __pyx_pybuffernd_tE.diminfo[0].strides, __pyx_t_85, __pyx_pybuffernd_tE.diminfo[1].strides)) * 2.0) * (((*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_X.rcbuffer->pybuffer.buf, __pyx_t_86, __pyx_pybuffernd_X.diminfo[0].strides, __pyx_t_87, __pyx_pybuffernd_X.diminfo[1].strides)) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_X.rcbuffer->pybuffer.buf, __pyx_t_88, __pyx_pybuffernd_X.diminfo[0].strides, __pyx_t_89, __pyx_pybuffernd_X.diminfo[1].strides))) - (*__Pyx_BufPtrStrided2d(float *, __pyx_pybuffernd_delta.rcbuffer->pybuffer.buf, __pyx_t_90, __pyx_pybuffernd_delta.diminfo[0].strides, __pyx_t_91, __pyx_pybuffernd_delta.diminfo[1].strides))));
      }
    }
  }
 ...
 */
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_tE.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_tE);
...
static int __pyx_pymod_exec_softdtwc(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_softdtwc},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "softdtwc",
    __pyx_k_Created_on_Mon_Sep_10_21_20_04, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_dtw, __pyx_k_dtw, sizeof(__pyx_k_dtw), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_softdtwc, __pyx_k_softdtwc, sizeof(__pyx_k_softdtwc), 0, 0, 1, 1},
  {&__pyx_kp_s_softdtwc_pyx, __pyx_k_softdtwc_pyx, sizeof(__pyx_k_softdtwc_pyx), 0, 0, 1, 0},
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_reversed = __Pyx_GetBuiltinName(__pyx_n_s_reversed); if (!__pyx_builtin_reversed) __PYX_ERR(0, 102, __pyx_L1_error)
 ...
 *              np.ndarray[float, ndim=2] D,
 */
  __pyx_tuple__10 = PyTuple_Pack(19, __pyx_n_s_X, __pyx_n_s_delta, __pyx_n_s_D, __pyx_n_s_R, __pyx_n_s_E, __pyx_n_s_G, __pyx_n_s_gamma, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_d, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_z, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_tmp, __pyx_n_s_tE, __pyx_n_s_k); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(7, 0, 19, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_softdtwc_pyx, __pyx_n_s_softdtwc, 45, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initsoftdtwc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initsoftdtwc(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_softdtwc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_softdtwc(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_softdtwc(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_softdtwc(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("softdtwc", __pyx_methods, __pyx_k_Created_on_Mon_Sep_10_21_20_04, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_softdtwc) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "softdtwc")) {
      if (unlikely(PyDict_SetItemString(modules, "softdtwc", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *              np.ndarray[float, ndim=2] D,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8softdtwc_1softdtwc, NULL, __pyx_n_s_softdtwc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_softdtwc, __pyx_t_1) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init softdtwc", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init softdtwc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
