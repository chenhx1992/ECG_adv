...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 26 20:47:09 2018
...
class CarliniWagnerL2(Attack):
    ...
    def __init__(self, model, back='tf', sess=None, dtypestr='float32'):
        ...
        self.structural_kwargs = ['batch_size', 'confidence',
                                  ...
                                  'clip_min', 'clip_max',
                                  'largest_const', 'reduce_const', 
                                  'const_factor','independent_channels']
    ...
    def generate(self, x, **kwargs):
        ...
        :param independent_cahnnels: set to false optimizes for number of pixels changed,
                                     set to true(not recommended) returns numbers of channels changed. 
        """
        import tensorflow as tf
        from myattacks_tf_sdtw_0 import CarliniWagnerL2 as CWL2
        ...
        attack = CWL2(self.sess, self.model, self.batch_size,
                      ...
                      self.largest_const, self.reduce_const, self.const_factor, self.independent_cahnnels)
    ...
    def parse_params(self, y=None, y_target=None, nb_classes=None,
                     ...
                     abort_early=True, initial_const=1e-1,
                     clip_min=0, clip_max=1, 
                     largest_const=2e6, reduce_const=False, 
                     const_factor=2.0, independent_cahnnels=False):
        ...
        self.independent_cahnnels = independent_cahnnels
