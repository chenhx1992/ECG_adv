...
#        ann_label = classes[ann]
        ...
        file_sample = './cw_l2smooth_0_01_eval/R' + str(fid)+ '_' + str(ground_truth) + '_' + str(i) + '_' + str(ann) + '.csv'
        np.savetxt(file_sample, adv_sample[0,:], delimiter=",")
        
    num = num+1
        
file_result = './cw_l2smooth_0_01_eval/res'+ '_' + str(fid_from) + '_' + str(fid_to) + '.csv'
