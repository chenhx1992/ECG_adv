...
eotl2_params = {'y_target': target_a, 'learning_rate': 0.5, 'max_iterations': 500, 'initial_const': 1000, 'perturb_window': perturb_window, 'dis_metric': dis_metric, 'ensemble_size': ensemble_size, 'ground_truth': ground_truth_a}
